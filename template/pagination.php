...
function wpclean_template_pagination(){
...
?>
	...
	<div class="wrap-plugin">
		...
		<form action="options.php" method="POST" class="wpclean-form">
			...
			<?php settings_fields('wpclean_group_pagination'); ?> <!-- для вывода скрытых полей страницы настроек -->
			<?php do_settings_sections('wpclean_dashboard_section_pagination'); ?> <!-- эта функция непосредственно выводит секции и поля настроек -->
