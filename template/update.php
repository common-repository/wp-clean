...
function wpclean_template_update(){
...
?>
	...
	<div class="wrap-plugin">
		...
		<form action="options.php" method="POST" class="wpclean-form">
			...
			<?php settings_fields('wpclean_group_update'); ?> <!-- для вывода скрытых полей страницы настроек -->
			<?php do_settings_sections('wpclean_dashboard_section_update'); ?> <!-- эта функция непосредственно выводит секции и поля настроек -->
