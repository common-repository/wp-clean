...
function wpclean_template_archives_pages(){
...
?>
	...
	<div class="wrap-plugin">
		...
		<form action="options.php" method="POST" class="wpclean-form">
			...
			<?php settings_fields('wpclean_group_archives_pages'); ?> <!-- для вывода скрытых полей страницы настроек -->
			<?php do_settings_sections('wpclean_dashboard_section_archives_pages'); ?> <!-- эта функция непосредственно выводит секции и поля настроек -->
